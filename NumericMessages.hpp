...
# define ERR_USERNOTINCHANNEL(client, nick, channel) ":serverhost 441 " + client + " " + nick + " " + channel + " :They aren't on that channel\r\n"
...
# define RPL_TOPICWHOTIME(channelName, nickName, setterNickname, time) ":serverhost 333 " + nickName + " " + channelName + " " + timeToString(time) + " " + setterNickname + "\r\n"
